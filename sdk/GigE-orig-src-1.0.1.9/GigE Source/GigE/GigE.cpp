												...
												p_u32 pleoraErrorDescriptionLen )
{
	...
	*deviceHdl = new GigEDevice(deviceDescriptor, &iResult);
...
{
	GigEDevice* deviceHdlInt = (GigEDevice*) deviceHdl;
...
{
	dbl temperatureConvertedExp = exp(((1 / ((dbl)temperature + 273.15)) - (1 / 298.15)) * 3988);
...
GigEDevice::GigEDevice(const str8 aDeviceDescriptor, p_i32 aResult)
{
	cDeviceInfo					= NULL;
	cDeviceInfoGEV				= NULL;
	cDeviceInfoU3V				= NULL;
